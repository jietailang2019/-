  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content" @click="toggleShopShow">
        <h2 class="content-title">
          ...
          <span class="content-name">{{shopInfo.name}}</span> <i class="content-icon"></i>
        </h2>
        <div class="shop-message">
          ...
          <span class="shop-message-detail">
            硅谷专送 <span>约 {{shopInfo.deliveryTime}} 分钟</span>
          </span>
    ...
    <div class="shop-header-discounts" @click="toggleSupportsShow">
      <div class="discounts-left">
        <div class="activity activity-green">
          <span class="content-tag"> <span class="mini-tag">{{shopInfo.supports&&shopInfo.supports[0].name}}</span> </span>
          <span class="activity-content ellipsis">{{shopInfo.supports&&shopInfo.supports[0].content}}</span>
        </div>
      </div>
      <div class="discounts-right">{{shopInfo.supports&&shopInfo.supports.length}} 个优惠</div>
    </div>
    ...
    <div class="activity-sheet"  v-show="supportsShow">
      <div class="activity-sheet-content" >
        ...
        <ul class="list">
          <li class="activity-item" :class="supportsClass[support.type]"  v-for="(support,index) in shopInfo.supports" :key="index">
            <span class="content-tag" >
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close" @click="toggleSupportsShow"></span>
        </div>
      </div>
