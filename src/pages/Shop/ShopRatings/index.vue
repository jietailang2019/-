    ...
    <div class="ratings-content">
      <div class="overview">
        ...
        <div class="overview-right">
          <div class="score-wrapper">
            ...
            <Ratings :score="shopInfo.serviceScore" :size="36" />
            <span class="score">{{shopInfo.serviceScore}}</span>
          </div>
          <div class="score-wrapper">
            <span class="title">商品评分</span>
            <Ratings :score="shopInfo.foodScore" :size="36" />
      ...
      <div class="ratingselect">
        <div class="rating-type border-1px">
          <span class="block positive" @click="setRateType(2)" :class="{active:selectRateType===2}">
            全部<span class="count" >{{ratingSize}}</span>
          </span>
          <span class="block positive" @click="setRateType(0)" :class="{active:selectRateType===0}">
            满意<span class="count">{{positiveSize}}</span>
          </span>
          <span class="block negative" @click="setRateType(1)" :class="{active:selectRateType===1}">
            不满意<span class="count">{{ratingSize-positiveSize}}</span>
          </span>
        </div>
          ...
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                <Ratings :score="rating.score" :size="24" />
...
<script>
  ...
  export default {
      data(){
        return{
          onlyShowText:false,//是否只显示有文本内容的
          selectRateType:2
        }
      },
      mounted(){
        this.get_shop_ratings().then(()=>{
          this.$nextTick(()=>{
      ...
      computed:{
        ...
        ...mapGetters(['ratingSize','positiveSize']),
        filterRatings(){
          const {ratings,onlyShowText,selectRateType} = this
